...
void forwardAdditiveImageAlign(cv::Mat& imgT, cv::Mat& imgI, cv::Rect& omega, cv::Mat &affine, int log_level, std::list<std::string> * log_str)
{
    ...
    std::cout << std::endl << "Start Forward Additive Algorithm!\n" << std::endl;
