...
void inverseAdditiveImageAlign(cv::Mat& imgT, cv::Mat& imgI, cv::Rect& omega)
{
    ...
    std::cout << std::endl << "Start Inverse Additive Algorithm!" << std::endl;
    ...
    */
    ...
    cv::Mat stdesctImage = cv::Mat::zeros(cols*rows, 6, CV_32F);
    ...
    */
    ...
    while(iter < MAX_ITER)
    {
        ...
        cv::Mat jac_x = (cv::Mat_<float>(6, 6) << 1+a22,     0,  -a12,     0,     0,     0,
                                                      0, 1+a22,     0,  -a12,     0,     0,
                                                   -a21,     0, 1+a22,     0,     0,     0,
                                                      0,  -a21,     0, 1+a22,     0,     0,
                                                      0,     0,     0,     0, 1+a22,  -a12,
